...
use FastLaravel\Http\Database\Connection;
use FastLaravel\Http\Database\Exception\ExceptionHandler;
use FastLaravel\Http\Database\Query\Grammars\MySqlGrammar;
use FastLaravel\Http\Database\Query\Grammars\PostgresGrammar;
use FastLaravel\Http\Database\Query\Grammars\SqlServerGrammar;
use FastLaravel\Http\Database\Query\Grammars\SQLiteGrammar;
use FastLaravel\Http\Database\QueryLogger;
...
class ConnectionFactory implements ConnectionFactoryInterface
{
     ...
     * @var null|string
     */
    protected $connectionClassName = 'FastLaravel\Http\Database\Connection';
    ...
    public function make(array $config)
    {
        ...
        return $this->makeConnection($config, !empty($config['lazy']))
            ->setReconnector(function (Connection $connection) use ($config) {
    ...
    protected function createSingleConnection(array $config, $lazy)
    {
        ...
        $connection->setExceptionHandler($this->createExceptionHandler($config))
