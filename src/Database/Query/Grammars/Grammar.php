...
namespace FastLaravel\Http\Database\Query\Grammars;

use FastLaravel\Http\Database\Query\Builder;
use FastLaravel\Http\Database\Query\Expression;
...
class Grammar
{
     ...
     *
     * @param  \FastLaravel\Http\Database\Query\Expression $expression
     * @return string
     */
     ...
     *
     * @param  \FastLaravel\Http\Database\Query\Builder
     * @return string
     */
     ...
     *
     * @param  \FastLaravel\Http\Database\Query\Builder $query
