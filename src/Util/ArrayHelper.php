...
class ArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = FastLaravel\Http\Util\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = FastLaravel\Http\Util\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = FastLaravel\Http\Util\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = FastLaravel\Http\Util\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = FastLaravel\Http\Util\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = FastLaravel\Http\Util\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * ];
     *
     * $result = FastLaravel\Http\Util\ArrayHelper::Filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = FastLaravel\Http\Util\ArrayHelper::Filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     ...
     * ```
     *
     * $result = FastLaravel\Http\Util\ArrayHelper::Filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
